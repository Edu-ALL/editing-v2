    ...
    <nav class="navbar" style="background-color: var(--bs-white)">
        <div class="container py-2 px-4">
            <a class="navbar-brand" href="/login/admin">
                <img class="img-logo " src="/assets/logo.webp" alt="" width="150px" height="auto">
            </a>
    ...
    @endif --}}
        ...
        <div class="row mt-4 justify-content-center gap-3">
            <div class="col col-md-8 mt-3">
                <form class="text-start" autocomplete="off" action="{{ route('self-add-editor') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                <div class="d-flex">
                                    <div class="me-3 col">
                                        <label for="firstName" class="form-label">First name <i
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" aria-describedby="lastName"
                                            name="last_name">
                                        @error('last_name')
                                            <div class="alert text-danger fs-10">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="d-flex">
                                    <div class="me-3 col">
                                        ...
                                        <input type="email" class="form-control" value="{{ $request->get('email') }}"
                                            autocomplete="off" name="email" readonly>
                                        @error('email')
                                            <div class="alert text-danger fs-10">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        <label for="phone" class="form-label">Phone <i
                                                class="text-danger">*</i></label>
                            ...
                            <div class="mb-3">
                                <div class="d-flex">
                                    <div class="me-3 col">
                                        <label for="graduatedFrom" class="form-label">Graduated From <i
                                                class="text-danger">*</i></label>
                                    ...
                                    <div class="col">
                                        <label for="major" class="form-label">Major <i
                                                class="text-danger">*</i></label>
                                        <input type="text" class="form-control" autocomplete="off" name="major"
                            ...
                            <div class="mb-3">
                                <div class="d-flex">
                                    ...
                                    <div class="col">
                                        <label for="confirmationPassword" class="form-label">Confirmation Password <i
                                                class="text-danger">*</i></label>
