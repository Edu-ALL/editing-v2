                        ...
                        <div class="col-md col-12 p-0 userCard profile" style="cursor: default">
                            ...
                            <div class="col d-flex align-items-center justify-content-center pb-md-3 pb-3">
                                <a class="btn btn-download d-flex align-items-center gap-2"
                                    href={{ asset('uploaded_files/program/essay/students/' . str_replace(' ', '', $essay->attached_of_clients)) }}>
                                ...
                                <form action="" class="p-0">
                                    <div class="col-12 d-flex flex-lg-row flex-column mb-3 gap-lg-2 gap-3">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control inputField py-2 px-3 w-100" disabled
