                ...
                <div class="container main-content m-0">
                    <div class="row gap-2">
                        <div class="col-md col-12 p-0 userCard profile" style="cursor: default">
                            ...
                            @endif
                            @if (isset($essay->essay_editors->managing_file) && $essay->essay_editors->notes_managing != null)
                                <div class="headline d-flex align-items-center gap-3">
                                    <img src="/assets/download.png" alt="">
                        ...
                        <div class="col-md-8 col-12 p-0 userCard" style="cursor: default">
                            <div class="headline d-flex justify-content-between">
                                ...
                                <div class="col-md-4 col-4 d-flex align-items-center justify-content-end gap-md-3 gap-2">
                                    <a href="/editor/all-essays/ongoing-essay-list"><img src="/assets/back.png"
                                            alt=""></a>
                                </div>
                            </div>
                                ...
                                <div class="col-12 d-flex flex-lg-row flex-column mb-3 gap-2">
                                    <div class="col">
                                        ...
                                        <div class="col mb-3">
                                            ...
                                            <div
                                                class="col d-flex align-items-center justify-content-center pb-md-4 pt-md-2 pb-4 pt-2">
                                                <img class="img-word" src="/assets/logo-word.png" alt="">
                                            </div>
                        ...
                        <h6>Download</h6>
                                    ...
                                    <div class="col-lg-7 col">
                                                ...
                                                @foreach ($essay_revise->reverse() as $revise)
                                                    @if ($revise->role == 'managing_editor')
                                                        <div class="chat-message-left pb-3">
                                                            <div>
                                                                <div class="text-muted d-none small text-nowrap mt-2">2:33
                                                                    am</div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <p class="mb-2" style="font-size: 12px">Managing Editor
                                                                </p>
                                                                <p>{!! $revise->notes !!}</p>
                                                                    ...
                                                                    <p style="margin-top: -4px">
                                                                        <a class="d-block mt-2"
                                                                            ...
                                                                            style="color: var(--blue)"><img
                                                                                ...
                                                                                alt="" width="14"
                                                                                height="14" style="margin-right: 2px">
                                                    ...
                                                    @elseif ($revise->role == 'editor')
                                                        <div class="chat-message-right pb-3">
                                                            <div class="text-end">
                                                                <div class="text-muted d-none small text-nowrap mt-2">2:34
                                                                    am</div>
                                                            </div>
                                                            <div
                                        ...
                                        <div class="col mt-3 mb-2">
                                            ...
                                            <div class="h-100 p-0">
                                                <input class="form-control p-1 ps-2 inputField h-100" id="formFileSm"
                                                    name="uploaded_revise_file" form="form-revise" type="file"
                                        ...
                                        <div class="col d-flex align-items-center justify-content-center py-3">
                                            <form
                                                action="{{ route('revise-editor-essay', ['id_essay' => $essay->id_essay_clients]) }}"
                                                enctype="multipart/form-data" method="POST" class="p-0"
                                                id="form-revise">
                                                @csrf
                                ...
                                <div class="col-12 d-flex flex-md-row flex-column justify-content-center py-3 gap-3"
                                    ...
                                    <div class="col">
                                        <div class="form-control d-flex align-items-center gap-2"
                                            ...
                                            <input class="form-check-input" type="checkbox" value="1"
                                                name="check_file" id="myCheck" onclick="checkUpload()"
                                                style="box-shadow: none">
                                    ...
                                    <div class="col">
                                        <div class="d-none h-auto p-0" id="inputField">
                                            <input class="form-control ps-2 inputField h-100 w-100" id="uploadAcc"
                                                name="uploaded_acc_file" form="form-accept" type="file"
                                                style="box-shadow: none; padding: 6px 12px">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 d-flex justify-content-center pt-3"
                                    style="border-top: 1px solid var(--light-grey)">
                                    <form
                                        action="{{ route('verify-editor-essay', ['id_essay' => $essay->id_essay_clients]) }}"
