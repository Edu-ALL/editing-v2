          ...
          <div class="col-md-8 col-12 p-0 userCard" style="cursor: default">
            <div class="headline d-flex justify-content-between">
              ...
              <div class="col-md-4 col-4 d-flex align-items-center justify-content-end gap-md-3 gap-2">
                <a href="/editor/all-essays/completed-essay-list"><img src="/assets/back.png" alt=""></a>
              </div>
            </div>
            ...
            <div class="col-12 d-flex px-3 py-3 feedback">
              <div class="col d-flex flex-row align-items-center justify-content-center gap-3">
                ...
                <div class="col-auto d-flex align-self-center">
                  @if ($feedback != null)
                    <span class="fa fa-star {{ $feedback->option1 >= 1 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option1 >= 2 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option1 >= 3 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option1 >= 4 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option1 >= 5 ? 'checked' : '' }}"></span>
                  @else
            ...
            <div class="col-12 d-flex px-3 py-3 feedback" style="border-top: 1px solid var(--light-grey)">
              <div class="col d-flex flex-row align-items-center justify-content-center gap-3">
                ...
                <div class="col-auto d-flex align-self-center">
                  @if ($feedback != null)
                    <span class="fa fa-star {{ $feedback->option2 >= 1 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option2 >= 2 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option2 >= 3 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option2 >= 4 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option2 == 5 ? 'checked' : '' }}"></span>
                  @else
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
            ...
            <div class="col-12 d-flex px-3 py-3 feedback" style="border-top: 1px solid var(--light-grey)">
              <div class="col d-flex flex-row align-items-center justify-content-center gap-3">
                ...
                <div class="col-auto d-flex align-self-center">
                  @if ($feedback != null)
                    <span class="fa fa-star {{ $feedback->option3 >= 1 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option3 >= 2 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option3 >= 3 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option3 >= 4 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option3 == 5 ? 'checked' : '' }}"></span>
                  @else
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
            ...
            <div class="col-12 d-flex px-3 py-3 feedback" style="border-top: 1px solid var(--light-grey)">
              <div class="col d-flex flex-row align-items-center justify-content-center gap-3">
                ...
                <div class="col-auto d-flex align-self-center">
                  @if ($feedback != null)
                    <span class="fa fa-star {{ $feedback->option4 >= 1 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option4 >= 2 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option4 >= 3 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option4 >= 4 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option4 == 5 ? 'checked' : '' }}"></span>
                  @else
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
            ...
            <div class="col-12 d-flex px-3 py-3 feedback" style="border-top: 1px solid var(--light-grey)">
              <div class="col d-flex flex-row align-items-center justify-content-center gap-3">
                ...
                <div class="col-auto d-flex align-self-center">
                  @if ($feedback != null)
                    <span class="fa fa-star {{ $feedback->option5 >= 1 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option5 >= 2 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option5 >= 3 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option5 >= 4 ? 'checked' : '' }}"></span>
                    <span class="fa fa-star {{ $feedback->option5 == 5 ? 'checked' : '' }}"></span>
                  @else
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
                    <span class="fa fa-star"></span>
