                ...
                <div class="container main-content m-0">
                    <div class="row gap-2">
                        <div class="col-md col-12 p-0 userCard profile" style="cursor: default">
                            ...
                            <div
                                class="col d-flex flex-column px-3 py-md-4 py-4 my-md-1 countEssay text-center justify-content-center">
                                <strong class="mb-3">
                                    How would you rate the editor's revision of the mentee's essay?
                                </strong>
                                <div class="px-3" style="font-size: 12px; text-align:justify;">
                                    <form
                                        action="{{ url('/editor/all-essays/completed/detail/' . $essay_editor->essay_clients->id_essay_clients) }}"
                                        method="POST">
                                        @csrf
                                        <input type="hidden" name="essay_editor" id=""
                                            value="{{ $essay_editor->id_essay_editors }}">
                                        <input type="hidden" name="managing_editor" id=""
                                            value="{{ Auth::guard('web-editor')->user()->id_editors }}">

                                        <div class="form-check mb-1 text-dark">
                                            <input class="form-check-input mt-1" type="radio" name="feedback"
                                                value="0" id="feedback1" {{$managing_feedback && $managing_feedback->feedback == 0 ? 'checked' : '' }} {{$managing_feedback ? 'disabled' : ''}}>
                                        ...
                                        <div class="form-check mb-1 text-dark">
                                            <input class="form-check-input mt-1" type="radio" name="feedback"
                                                value="1" id="feedback2" {{$managing_feedback && $managing_feedback->feedback == 1 ? 'checked' : '' }} {{$managing_feedback ? 'disabled' : ''}}>
                                        ...
                                        <div class="form-check mb-1 text-dark">
                                            <input class="form-check-input mt-1" type="radio" name="feedback"
                                                value="2" id="feedback3" {{$managing_feedback && $managing_feedback->feedback == 2 ? 'checked' : '' }} {{$managing_feedback ? 'disabled' : ''}}>
                                        ...
                                        <div class="form-check mb-1 text-dark">
                                            <input class="form-check-input mt-1" type="radio" name="feedback"
                                                value="3" id="feedback4" {{$managing_feedback && $managing_feedback->feedback == 3 ? 'checked' : '' }} {{$managing_feedback ? 'disabled' : ''}}>
