                            ...
                            <div class="row profile-editor px-md-4 py-md-4 px-3 py-4 mb-2"
                                ...
                                <div
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>{{ $essay_editor->essay_clients->client_by_id->first_name . ' ' . $essay_editor->essay_clients->client_by_id->last_name }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>{{ $essay_editor->essay_clients->client_by_id->email ? $essay_editor->essay_clients->client_by_id->email : '-' }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-7">
                                            <p>{!! $essay_editor->essay_clients->client_by_id->address ? $essay_editor->essay_clients->client_by_id->address : '-' !!}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
