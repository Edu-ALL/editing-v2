...
<div class="col-md-2 col-2 sidenav py-4 px-md-0 px-2 text-center">
    ...
    <div
        ...
        <a class="row w-100" href="/editors/dashboard" style="cursor: pointer">
            <div class="col-md-3">
                <img class="{{ request()->is('editors/dashboard') ? 'active' : 'non-active' }}"
        ...
        <a class="row w-100" href="/editors/essay-list" style="cursor: pointer">
            <div class="col-md-3 ps-lg-1">
                <img class="{{ request()->is('editors/essay-list') || request()->is('editors/essay-list/*') ? 'active' : 'non-active' }}"
                    src="/assets/essay-list-blue.png" alt="">
            </div>
            <div class="col-7 pt-1 my-auto d-none d-md-inline">
                <h6
                    class="menu {{ request()->is('editors/essay-list') || request()->is('editors/essay-list/*') ? 'active' : '' }}">
                    Essay List</h6>
            </div>
        </a>
    </div>
