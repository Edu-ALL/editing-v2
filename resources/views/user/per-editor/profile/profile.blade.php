        ...
        <div class="row gap-2">
          <div class="col-md col-12 p-0 userCard profile">
            ...
            <div class="col d-flex align-items-center justify-content-center py-md-4 py-4">
              <div class="pic-profile d-flex align-items-center justify-content-center">
                <img class="img-fluid" id="img-profile" src={{ Storage::url('user/editors/'.$editor->image) }} alt="">
              </div>
            </div>
          ...
          <div class="col-md-8 col-12 p-0 userCard">
            ...
            <div class="row field px-md-3 py-md-4 px-3 py-4" style="overflow: auto !important">
              ...
              @endif
              <form action="{{ route('update-editor-profile', ['id_editors' => $editor->id_editors]) }}" class="p-0" id="form-profile" onsubmit="swal.showLoading()" enctype="multipart/form-data" method="POST">
                @csrf
