                ...
                <div class="container main-content m-0">
                    <div class="row gap-2">
                        <div class="col-md col-12 p-0 userCard profile">
                            ...
                            @include('user.per-editor.essay-list.editors-deadline.index')
                            <div class="headline d-flex align-items-center gap-3">
                        ...
                        <div class="col-md-8 col-12 p-0 userCard profile">
                            ...
                            <div class="row profile-editor px-md-4 py-md-4 px-3 py-4 mb-2"
                                ...
                                <div
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>
                                                @if (isset($essay_editor->essay_clients->client_by_id))
                                                    {{ $essay_editor->essay_clients->client_by_id->first_name . ' ' . $essay_editor->essay_clients->client_by_id->last_name }}
                                                @else
                                                    {{ $essay_editor->essay_clients->client_by_email->first_name . ' ' . $essay_editor->essay_clients->client_by_email->last_name }}
                                                @endif
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>
                                                @if (isset($essay_editor->essay_clients->client_by_id))
                                                    {{ $essay_editor->essay_clients->client_by_id->email }}
                                                @else
                                                    {{ $essay_editor->essay_clients->client_by_email->email }}
                                                @endif
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row d-flex">
                                        ...
                                        <div class="col-7">
                                            <p>
                                                ...
                                                @else
                                                    {!! $essay_editor->essay_clients->client_by_email->address !!}
                                                @endif
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="row profile-editor px-md-4 py-md-4 px-3 py-4 mb-4"
                                style="overflow: auto !important">
                                <div
                                    class="col-md student-desc d-flex flex-column justify-content-center gap-lg-3 gap-2 ps-lg-3 px-2 border-0">
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>{{ $essay_editor->essay_clients->university->university_name }}</p>
                                        </div>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                        <div class="col-md-3 col-4">
                                        ...
                                        <div class="col-7">
                                            <p>{{ $essay_editor->essay_clients->essay_title }}</p>
                                        </div>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                        <div class="col-md-3 col-4">
                                        ...
                                        <div class="col-7">
                                            <p>{!! $essay_editor->essay_clients->essay_prompt !!}</p>
                                        </div>
                                    </div>
                                    {{-- <div class="row d-flex">
                                        <div class="col-md-3 col-4">
                                            ...
                                            <ul class="d-flex flex-column gap-2">
                                                <li>
                                                    <p><b>Essay Deadline</b> :
                                                        {{ date('D, d M Y', strtotime($essay_editor->essay_clients->essay_deadline)) }}
                                                    </p>
                                                </li>
                                                <li>
                                                    <p><b>Application Deadline</b> :
                                                        {{ date('D, d M Y', strtotime($essay_editor->essay_clients->application_deadline)) }}
                                                    </p>
                                                </li>
                                            </ul>
                                        </div>
