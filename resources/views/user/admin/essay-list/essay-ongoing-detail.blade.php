                        ...
                        <div class="col-md col-12 p-0 userCard profile">
                            ...
                            <div class="col d-flex align-items-center justify-content-center pb-md-3 pb-3">
                                <a class="btn btn-download d-flex align-items-center gap-2"
                                    href={{ asset('uploaded_files/program/essay/students/' . $ongoing->attached_of_clients) }}>
                            ...
                            <div class="row profile-editor px-md-4 py-md-4 px-3 py-4 mb-2"
                                ...
                                <div
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>{{ $ongoing->client_by_id->first_name . ' ' . $ongoing->client_by_id->last_name }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                ...
                                <form action="" class="p-0">
                                    <div class="col-12 d-flex mb-3">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control inputField py-2 px-3" disabled
                                                value="{{ $ongoing->university->university_name }}">
                                        </div>
                                        <div class="col-6">
                                            <h6 class="pb-2">Essay Title :</h6>
                                            <input type="text" class="form-control inputField py-2 px-3" disabled
                                                value="{{ $ongoing->essay_title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex mb-3">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control inputField py-2 px-3" disabled
                                                value="{{ date('D, d M Y', strtotime($ongoing->essay_deadline)) }}">
                                        </div>
                                        <div class="col-6">
                                            <h6 class="pb-2">Application Deadline :</h6>
                                            <input type="text" class="form-control inputField py-2 px-3" disabled
                                                value="{{ date('D, d M Y', strtotime($ongoing->application_deadline)) }}">
                                        </div>
                                    </div>
                                </form>
                            </div>
                                        ...
                                        <tr style="cursor: default">
                                            ...
                                            <td class="d-flex align-items-center justify-content-center">
                                                <div class="form-check d-flex align-items-center justify-content-center">
                                                    <input class="form-check-input" type="radio" name="id_editors"
                                                        id="flexRadioDefault1" value="{{ $editor->id_editors }}">
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
