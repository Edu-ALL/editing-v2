                        ...
                        <div class="col-md col-12 p-0 userCard profile">
                            ...
                            <div class="col d-flex align-items-center justify-content-center pb-md-3 pb-3">
                                <a class="btn btn-download d-flex align-items-center gap-2"
                                    href={{ Storage::url('program/essay/students/' . $essay_editor->essay_clients->attached_of_clients) }}>
                            ...
                            <div class="col d-flex align-items-center justify-content-center pb-md-3 pb-3">
                                @if ($essay_editor->managing_file)
                                    <a class="btn btn-download d-flex align-items-center gap-2"
                                        href={{ Storage::url('program/essay/revised/' . $essay_editor->managing_file) }}>
                                        <img src="/assets/download.png" alt="">
                                        <h6>Download</h6>
                                    </a>
                                @else
                                    @if (str_contains($essay_editor->attached_of_editors, 'Revised'))
                                        <a class="btn btn-download d-flex align-items-center gap-2"
                                            href={{ Storage::url('program/essay/revised/' . $essay_editor->attached_of_editors) }}>
                                            <img src="/assets/download.png" alt="">
                                            <h6>Download</h6>
                                        </a>
                                    @else
                                        <a class="btn btn-download d-flex align-items-center gap-2"
                                            href={{ Storage::url('program/essay/editors/' . $essay_editor->attached_of_editors) }}>
                                            <img src="/assets/download.png" alt="">
                                            <h6>Download</h6>
                                        </a>
                                    @endif
                            ...
                            <div class="row profile-editor px-md-4 py-md-4 px-3 py-4 mb-2"
                                ...
                                <div
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>{{ $essay_editor->essay_clients->client_by_id ? $essay_editor->essay_clients->client_by_id->first_name . ' ' . $essay_editor->essay_clients->client_by_id->last_name : $essay_editor->essay_clients->client_by_email->first_name . ' ' . $essay_editor->essay_clients->client_by_email->last_name }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>{{ $essay_editor->essay_clients->client_by_id ? $essay_editor->essay_clients->client_by_id->email : $essay_editor->essay_clients->client_by_email->email }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-7">
                                            <p>{!! $essay_editor->essay_clients->client_by_id
                                    ...
                                    <div class="col-12 d-flex mb-4" style="overflow: auto !important">
                                        <div class="col">
                                            ...
                                            <div style="font-size: 12px">
                                                {!! $essay_editor->essay_clients->essay_notes !!}
                                            </div>
                                        </div>
                                    </div>
