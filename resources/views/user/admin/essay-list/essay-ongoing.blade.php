            ...
            <div class="col" style="overflow: auto !important">
                ...
                <div class="container main-content m-0">
                  ...
                  <tr onclick="window.location='/admin/essay-list/ongoing/detail/{{ $essay->id_essay_clients }}'">
                    ...
                    <td>{{ isset($essay->mentor) ? $essay->mentor->first_name.' '.$essay->mentor->last_name : '-' }}</td>
                    <td>
                      @if ($essay->status_essay_clients == 0 || $essay->status_essay_clients == 4 || $essay->status_essay_clients == 5)
                          -
                      @else{{ $essay->essay_editors->editor->first_name.' '.$essay->essay_editors->editor->last_name }}
                      @endif
                    </td>
                ...
                rowCallback: function(row, data) {
                    $(row).on('click', function() {
                        window.location.href =
                            `/admin/essay-list/ongoing/detail/${data.id_essay_clients }`;
                    });
                }
            });
        });
