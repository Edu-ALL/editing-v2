...
<head>
    ...
    <link rel="stylesheet" href="/css/forgot-password/mentor-forgot-password.css">
</head>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 cardLogin mt-3">
                ...
                <hr>
                <form action="{{ route('send-reset-password-mentor') }}" method="POST">
                    @csrf
                ...
                <div class="container text-center mt-3 mb-2 backLogin">
                    <a href="/login/mentor">Back to Login</a>
                </div>
            </div>
        </div>
    </div>
