...
class Export extends Controller
{
    ...
    {       
        ...
        if ($request->all()) {
            ...
            $essay_editors = EssayEditors::with(['essay_clients.client_by_id', 'essay_clients.client_by_email', 'essay_clients.program', 'status', 'editor'])->where('status_essay_editors', 7)->whereMonth('uploaded_at', $f_month)->whereYear('uploaded_at', $f_year)
